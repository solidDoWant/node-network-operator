...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BridgeSpec2) DeepCopyInto(out *BridgeSpec2) {
	*out = *in
	if in.MTU != nil {
		in, out := &in.MTU, &out.MTU
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BridgeSpec2.
func (in *BridgeSpec2) DeepCopy() *BridgeSpec2 {
	if in == nil {
		return nil
	}
	out := new(BridgeSpec2)
